...
const runComparison = () => {
  const letfSideStats = document.querySelectorAll('#left-summery .notification');
  const rightSideStats = document.querySelectorAll('#right-summery .notification');

  letfSideStats.forEach((leftStat , index) => {
    const rightStat = rightSideStats[index];

    const letfSideValue = leftStat.dataset.value;
    const rightSideValue = rightStat.dataset.value;

    if(letfSideValue > rightSideValue ) {
